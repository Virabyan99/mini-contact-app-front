  ...
  return (
    <div>
      ...
      <section className="py-16 bg-gray-50 text-center">
        <h2 className="text-4xl font-semibold mb-6">Why Choose Our App?</h2>
      ...
      <section className="py-16 bg-blue-50 text-center">
        ...
        <div className="flex flex-wrap justify-center gap-12">
          <div className="max-w-xs p-6 bg-white rounded-lg shadow-md">
            <h3 className="text-xl font-semibold mb-4">Add Contacts</h3>
            <p>Add contacts manually or import them from various sources.</p>
          </div>
          <div className="max-w-xs p-6 bg-white rounded-lg shadow-md">
            <h3 className="text-xl font-semibold mb-4">Organize Easily</h3>
